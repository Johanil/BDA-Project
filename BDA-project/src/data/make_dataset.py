...
def main():
    ...
    pre_risk.to_csv(r'C:\BDA-Project\BDA-project\data\processed\pre19fwi4Risk.csv')
    post_risk.to_csv(r'C:\BDA-Project\BDA-project\data\processed\post18fwi4Risk.csv')
    risk2018.to_csv(r'C:\BDA-Project\BDA-project\data\processed\risk2018.csv')
    risk2019.to_csv(r'C:\BDA-Project\BDA-project\data\processed\risk2019.csv')
    risk2020.to_csv(r'C:\BDA-Project\BDA-project\data\processed\risk2020.csv')
    pre_merged.to_csv(r'C:\BDA-Project\BDA-project\data\processed\pre19fwi4Merged.csv')
    post_merged.to_csv(r'C:\BDA-Project\BDA-project\data\processed\post18fwi4Merged.csv')
    merged_2018.to_csv(r'C:\BDA-Project\BDA-project\data\processed\2018merged.csv')
    merged_2019.to_csv(r'C:\BDA-Project\BDA-project\data\processed\2019merged.csv')
    merged_2020.to_csv(r'C:\BDA-Project\BDA-project\data\processed\2020merged.csv')
